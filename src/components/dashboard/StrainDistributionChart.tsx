...
const data = [
  { name: "Workforce Effort", value: 65, color: "#C7791A" },
  { name: "Managerial Effort", value: 20, color: "#1F3A4A" },
  { name: "Clinical Load", value: 15, color: "#D1D5DB" },
];

export function StrainDistributionChart() {
  return (
