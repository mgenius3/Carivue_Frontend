    ...
    >
      <div className="flex flex-col gap-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-10 rounded-3xl border border-gray-100 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 bg-[#F9FAFB] rounded-lg"><MessageSquare size={18} className="text-[#1F3A4A]" /></div>
              <div>
          ...
          <div className="bg-white p-10 rounded-3xl border border-gray-100 shadow-sm flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2 bg-[#F9FAFB] rounded-lg"><Mail size={18} className="text-[#1F3A4A]" /></div>
                <div>
              ...
              <div className="mt-10 space-y-8">
                <div className="flex items-start gap-4">
                  <div className="p-2.5 bg-[#FFF8F1] rounded-xl"><Phone size={18} className="text-secondary" /></div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="p-2.5 bg-[#FFF8F1] rounded-xl"><Mail size={18} className="text-secondary" /></div>
                  <div>
        ...
        <div className="mt-6">
          ...
          <div className="bg-transparent px-2"><Accordion items={faqItems} /></div>
